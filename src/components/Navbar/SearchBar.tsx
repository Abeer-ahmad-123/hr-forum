...
const SearchBar = () => {
  ...
  return (
    <form
      className={`relative flex max-w-[690px] flex-1 items-center space-x-2 rounded-full border border-gray-200 py-1  pl-3 hover:bg-white max-sm:max-w-[160px] ${styles}`}
    >
      <input
        type="text"
        className="flex-1 bg-transparent font-light text-black outline-none "
