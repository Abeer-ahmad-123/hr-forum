...
const SearchBar = () => {
  ...
  return (
    <form className="max-sm:max-w-[160px] relative flex h-10 w-10 max-w-[420px] flex-1 items-center space-x-2 rounded-full border border-none border-gray-200 bg-bg-tertiary py-1 pl-3 outline-none focus-within:w-full hover:border-blue-500 focus:w-full dark:border-gray-600 dark:bg-bg-tertiary-dark dark:hover:border-gray-400 dark:hover:bg-bg-tertiary-dark md:h-11 md:w-11">
      <input
        ref={refForInput}
        ...
        value={search}
        type="text"
        className="focus:max-sm:w-full ml-4 w-0 rounded-r-full border border-none bg-bg-tertiary pl-3 font-light  text-black placeholder-black placeholder-opacity-60 outline-none placeholder:text-base placeholder:font-medium dark:bg-bg-tertiary-dark dark:text-white dark:placeholder-[#9F9F9F] sm:w-full md:ml-8 md:pl-2"
        placeholder="Search Forum"
      />
      <label className="max-sm:left-[-3px] absolute left-[-6px]">
        <div
