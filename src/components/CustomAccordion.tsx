        ...
        <AccordionItem value="forumRules">
          ...
          <AccordionContent>
            <Accordion type="single" collapsible>
              <ul className="text-left bg-white px-4 dark:bg-bg-primary-dark dark:text-white rounded-2xl">
                {rulesData.map((item, index) => (
                  <li key={index}>
                    ...
                    >
                      ...
                      <AccordionContent>
                        <div className="text-xs ml-6 font-normal text-text-grey dark:text-white">
                          {item.description}
                        </div>
                      </AccordionContent>
                    </AccordionItem>
