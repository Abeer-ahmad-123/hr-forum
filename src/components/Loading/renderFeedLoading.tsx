...
const RenderFeedLoading = () => {
  return (
    <>
      <div className="mx-auto mb-5 h-fit w-full max-w-full cursor-pointer rounded-xl bg-white shadow-lg dark:bg-bg-primary-dark dark:text-gray-300 lg:max-w-screen-md">
