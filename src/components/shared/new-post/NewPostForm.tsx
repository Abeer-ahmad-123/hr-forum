...
export default function NewPostForm({
  ...
  return (
    <div className="min-h[635px] flex max-w-[759px] flex-col gap-[18px] rounded-xl bg-white  px-[16px] py-[16px] dark:bg-bg-primary-dark custom-sm:px-[24px] custom-sm:pb-[20px] custom-sm:pt-[28px] ">
      <div className="flex flex-col justify-between gap-[18px]">
        <button
          ...
          <span className="tetx-black font-[550] opacity-60 dark:text-white">
            Go back
          </span>
        </button>
      ...
      <div className=" m-0 flex flex-col-reverse items-start justify-start gap-[18px] ">
        <div className="flex h-[88px] w-full flex-col gap-[8px]">
          ...
          <input
            className=" title-input flex h-[56px] rounded-[20px] border-bg-tertiary px-[20px] py-[8px]  font-primary  text-base placeholder-gray-500 ring-1  ring-gray-300 transition duration-200 ease-in-out placeholder:opacity-60 focus:outline-none focus:ring-purple-100 dark:bg-bg-primary-dark dark:text-white  dark:placeholder-white max-sm:w-[300px] md:w-full md:text-lg lg:text-xl"
            type="text"
      ...
      <div className="m-0 flex  h-[42px] w-[142px] items-center justify-start gap-[8px] rounded-[6px] bg-[#F1F5F9] p-[5px] dark:bg-bg-tertiary-dark">
        <div
          ...
          className={`m-0 flex w-[60px] items-center justify-center   dark:text-white ${
            !postImage
              ? 'h-[32px] w-[60px] rounded-[3px] bg-white px-[16px] py-[6px] font-primary text-sm transition duration-500 ease-in-out dark:bg-bg-primary-dark'
              ...
              {selectedImage ? (
                ...
                <>
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-xs text-bg-green  ">
                      Upload Image
                    ...
                    <p className="text-xs text-gray-300 opacity-60 dark:text-white ">
