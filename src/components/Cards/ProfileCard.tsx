...
const ProfileCard = () => {
  ...
  return (
    <>
      <div>
        <div className="relative ml-[50px] mr-[25px] h-auto w-[200px]  cursor-pointer overflow-hidden  rounded-[10px] bg-white shadow-lg dark:bg-slate-800 dark:text-white">
          <Image
