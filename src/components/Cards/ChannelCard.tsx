...
const ChannelCard = () => {
  ...
  return channels.length ? (
    <div
      className={`sticky top-[20px] mr-4 mt-[20px] h-auto max-h-screen w-[225px] rounded-[10px] border border-solid border-gray-300 bg-white px-[10px] pb-2 pt-3 shadow-lg dark:bg-slate-800 dark:text-white max-md:w-full`}>
