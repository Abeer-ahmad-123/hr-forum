  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          //removed snadow-lg
          'fixed left-[50%] top-[50%] z-50 mx-auto grid max-h-[90vh] min-h-[90vh] w-full max-w-[759px] translate-x-[-50%] translate-y-[-50%] border bg-background px-[24px] pb-[20px] pt-[28px] duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] dark:bg-dark-background max-[417px]:p-2 sm:rounded-lg md:w-full md:max-w-[759px]',
          className,
        )}
        {...props}>
        <button
