  ...
  return (
    <div
      ...
      className={`${!className && 'mr-4'} 
       ...
       ${className} mt-[10px] max-h-screen w-[225px] cursor-pointer rounded-[10px] border border-solid border-gray-300  bg-white  px-[10px] pb-2 pt-3 shadow-lg dark:bg-slate-800`}>
