const SideCardBadge = () => {
  return (
    <>
      <div className="cursor-cursor sticky top-0 ml-[8%]  h-auto max-h-screen w-full rounded-[10px] bg-white  pb-2 pt-3 shadow-lg dark:bg-slate-800 dark:text-white max-md:-ml-[1%]  ">
